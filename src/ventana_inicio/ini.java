...
public class ini extends javax.swing.JFrame {
    ...
    public ini() {
        initComponents();
        setSize(1150, 520);//cambiar tama̱o de la ventana
    ...
    private void initComponents() {
        ...
        jugar.setBounds(280, 270, 200, 70);
        ...
        jButton2.setBounds(550, 270, 200, 70);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventana_inicio/Inicio1.jpg"))); // NOI18N
        jLabel1.setText("EL AHORCADO");
        jLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 1150, 520);
